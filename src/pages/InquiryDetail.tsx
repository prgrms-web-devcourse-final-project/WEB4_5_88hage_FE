export default function InquiryDetail() {
  return (
    <div className="mainColor-gradient flex min-h-screen flex-col items-center bg-[#121212] px-0 py-0">
      <div className="flex min-h-screen w-full flex-col justify-start px-4 pt-8 pb-12 sm:px-4 md:px-12 lg:px-30">
        <div>
          <p className="mt-1 mb-3 text-sm font-bold text-[#E2E2E2] lg:mb-[54] lg:text-[32px]">
            안녕하세요, 홍길동님 👋
          </p>
        </div>
