export default function InquiryDetail() {
  return (
    <div className="min-h-screen bg-[#121212] flex flex-col items-center px-0 py-0">
      ...
      ">
        <div>
          <p className="text-sm lg:text-3xl font-bold text-[#E2E2E2] mt-1 mb-3 lg:mb-20">
            안녕하세요, 홍길동님 👋
          </p>
        </div>
        <div className="flex flex-col items-start lg:items-center pb-4 lg:pb-10">
          <h1 className="text-[20px] font-extrabold text-left mb-3 lg:text-3xl lg:text-center lg:mb-2 w-full">
        ...
        ">
          ...
          <span className="text-[#d2d2d2] lg:text-[#ffffff] text-[12px] lg:text-sm flex-1 text-left">
        ...
        <div className="mb-4 mt-3">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[#f6f6f6] text-[13px] lg:text-sm leading-relaxed ml-0 lg:ml-[25px]">
        ...
        <div className="flex justify-center pt-16 border-t-2 border-[#444]">
          <button className="bg-[#303236] text-[#D4D4D4] rounded-md w-full py-3 text-[15px] hover:bg-[#35383b] transition lg:w-auto lg:px-6 lg:py-2 lg:text-base">
            목록으로 이동
          </button>
        </div>
      </div>
