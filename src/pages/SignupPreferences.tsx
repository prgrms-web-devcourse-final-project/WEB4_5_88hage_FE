...
export default function SignupPreferences() {
  ...
  return (
    <div className="signup-bg lg:ml-[50%]">
      <div></div>
      <div className="flex max-w-150 flex-col gap-10">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-2.5">
            <Tag selected={tagSelectHandler} category="content" type="THEATER">
              연극 👏
            </Tag>
            ...
            <Tag selected={tagSelectHandler} category="content" type="CLASSIC">
              클래식 🎻
            </Tag>
            <Tag
              selected={tagSelectHandler}
            ...
            <Tag selected={tagSelectHandler} category="content" type="MUSICAL">
              뮤지컬 🎤
            </Tag>
            <Tag selected={tagSelectHandler} category="content" type="TOUR">
              관광지 🏛️
            </Tag>
            <Tag selected={tagSelectHandler} category="content" type="CULTURE">
              문화 시설 🗼
            </Tag>
