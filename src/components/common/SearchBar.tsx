...
export default function SearchBar() {
  return (
    <div className="flex flex-col items-center justify-center p-8">
      <div className="t4 from-main to-text mb-[25px] inline-block bg-gradient-to-r bg-clip-text text-[24px] text-transparent">
      ...
      <div className="relative w-[900px]">
        <input
          ...
          className="bg-gray-7 w-full rounded border border-[#313131] p-5 pr-12 font-semibold text-white"
        />
