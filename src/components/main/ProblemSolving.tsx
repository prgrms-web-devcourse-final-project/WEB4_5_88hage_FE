...
import solvePhoneImg1 from "@/assets/images/solve_phone_img1.png"
...
export default function ProblemSolving(){
  return (
    ...
    <div className='w-full flex justify-center pb-[calc(100px+40px) relative lg:w-fit'>
        <Image src={solvePhoneTopRightImg1} alt="하트 이미지"  className="w-[115px] h-[115px] lg:w-[140px] lg:h-[140px] absolute top-[30px] right-[-30px] lg:right-[-120px] lg:top-[60px] rotate-10" />
        <MainCellPhoneFrame img={solvePhoneImg1} altText="심심한 이미지"/>
