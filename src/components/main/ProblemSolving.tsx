...
export default function ProblemSolving(){
  return (
    ...
    <div className='w-full flex justify-center pb-[calc(100px+40px) relative lg:w-fit'>
        ...
        <div className="w-full rounded-[5px] absolute lg:bottom-[-30%] p-[1px] gradient-background lg:max-w-[335px] lg:left-[-50%]">
    ...
    <div className="w-full flex justify-center mt-[140px] lg:mt-0 lg:w-[160px]">
